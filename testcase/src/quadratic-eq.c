...
int main() {
	FLOAT a = f2F((unsigned int)(0.5));
	FLOAT b = f2F((unsigned int)(0.5));
	FLOAT c = f2F((unsigned int)(-0.5));
	...
	FLOAT x1_ans = f2F((unsigned int)(0.618));
	FLOAT x2_ans = f2F((unsigned int)(-1.618));
  set_bp();
